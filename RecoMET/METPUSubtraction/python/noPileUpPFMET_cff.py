...
pfCandidateToVertexAssociationForNoPileUpPFMEt = pfCandidateToVertexAssociation.clone(
...
noPileUpPFMEtSequence += pfCandidateToVertexAssociationForNoPileUpPFMEt
pfMETcorrType0ForNoPileUpPFMEt = pfMETcorrType0.clone(
    srcPFCandidateToVertexAssociations = cms.InputTag('pfCandidateToVertexAssociationForNoPileUpPFMEt')
)
noPileUpPFMEtSequence += pfMETcorrType0ForNoPileUpPFMEt

jvfJetIdForNoPileUpPFMEt = cms.EDProducer("JVFJetIdProducer",
    srcJets = cms.InputTag('calibratedAK5PFJetsForNoPileUpPFMEt'),
    srcPFCandidates = cms.InputTag('particleFlow'),
    srcPFCandToVertexAssociations = cms.InputTag('pfCandidateToVertexAssociationForNoPileUpPFMEt'),
...
noPileUpPFMEt = cms.EDProducer("NoPileUpPFMEtProducer",
    ...
    srcType0Correction = cms.InputTag('pfMETcorrType0ForNoPileUpPFMEt'),                    
